/****************************************************************
 * GameState.java Do not modify this file! The GameState class is used to
 * represent the Mancala Board during play. The current player is always assumed
 * to be on the bottom row. You are recommended to read and understand this
 * file.
 * -----------------------------------------------------------------------------
...
public final class GameState {
	...
	/**
	 * This constructor assigns a different initial number of stones in the bins
	 * of the mancala board than the default 4.
	 *
	 * @param initialStones
	 *            the initial number of stones in the bins must be > 0,
	 ...
	 * 
	 * @param source
	 *            the object out of which to construct a copy
	 */
	 ...
	 * 
	 * @return true; the game is over<br>
	 *         false; otherwise
	 */
	...
	/**
	 * provides a copy of the mancala board as an array of integers where the
	 * bin numbers are indexed in the following way:
	 * 
	 * <pre>
	 -----------------------------------------
	 |    | 12 | 11 | 10 |  9 |  8 |  7 |    |
	...
	/**
	 * provides a copy of the manacala board as a matrix of integers where the
	 * bin coordinates are indexed in the following way:
	 * 
	 * <pre>
	 -------------------------------------------------
	 ...
	 * 
	 * @param bin
	 *            the bin to querry for number of stones
	...
	/**
	 * returns a boolean based upon the state and the bin chosen. For
	 * efficiency, this method does not take into account state status or turns.
	 *
	 * @param bin
	 *            the proposed bin from which to advance the stones must be
	 ...
	 * 
	 * @param state
	 *            the initial state before the method executes, and the
	 *            resulting state once the method completes
	 * @param bin
	 *            the move to apply to the state
	 *
