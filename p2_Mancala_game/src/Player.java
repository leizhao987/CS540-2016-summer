/****************************************************************
 * Player.java Do not modify this file! This is the abstract class. You need to
 * extend this class to implement your own xxxPlayer.java. You are recommended
...
public abstract class Player {
	...
	/**
	 * Callback method to tell the player that it is its turn to move. It can
	 * always assume that the player will have at least one valid move.
	 *
	 * @param context
	 ...
	 *
	 * @param screenName
	 *            the name of the player that will appear on the game display
	 * @param whichPlayer
	 *            either 1 or 2 to indicate if the player is the one who goes
	 *            first. If other than 1 or 2 it defaults to 1
	 */
	 ...
	 *          The move must be a valid one according to the latest GameContext
	 *          sent to the player.
	 */
	public int getMove() {
		return move;
